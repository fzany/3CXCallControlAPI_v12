...
namespace OMSamples.Samples
{
    ...
    [SampleWarning("If script will be modifies destination for the existing DID rules. To repair configuration you need to restore configuration or revert changes manually")]
