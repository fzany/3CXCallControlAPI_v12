...
namespace OMSamples.Samples
{
    ...
    [SampleWarning("This sample does not create valid profile of extension and modify extention configuration, it just show how to work with FwdProfile object.")]
    [SampleDescription("Creates FwdProfile objects for extension 100. Shows how to set current profile fow extension and attach rules to the profile.")]
